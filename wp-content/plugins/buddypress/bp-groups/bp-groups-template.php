	...
	function bp_get_group_join_button( $group = false ) {
		...
		if ( ! empty( $group->is_member ) ) {
			...
			$button = array(
				...
				'link_text'         => __( 'グループを脱退', 'buddypress' ),
			...
			switch ( $group->status ) {
				...
				case 'public':
					$button = array(
						...
						'link_text'         => __( 'グループに参加', 'buddypress' ),
				...
				case 'private' :
					...
					if ( $group->is_invited ) {
						$button = array(
							...
							'link_text'         => __( '招待を受ける', 'buddypress' ),
					...
					// show a "Request Sent" button.
						...
						$button = array(
							...
							'link_text'         => __( '参加申請済み', 'buddypress' ),
					...
					// show a "Request Membership" button.
						...
						$button = array(
							...
							'link_text'         => __( '参加申請を送る', 'buddypress' ),
