...
function bp_email_get_schema() {
	return array(
		...
		'core-user-registration' => array(
			...
			/* translators: do not remove {} brackets or translate its contents. */
			'post_content' => __( "ようこそ!Piggiezへ。\n\nアカウントを有効化するために、以下のリンクをクリックしてください。: <a href=\"{{{activate.url}}}\">{{{activate.url}}}</a>", 'buddypress' ),
			/* translators: do not remove {} brackets or translate its contents. */
			'post_excerpt' => __( "ようこそ!Piggiezへ。\n\nアカウントを有効化するために、以下のリンクをクリックしてください。 {{{activate.url}}}", 'buddypress' ),
		),
		'core-user-registration-with-blog' => array(
			/* translators: do not remove {} brackets or translate its contents. */
			'post_title'   => __( '[{{{site.name}}}] Activate {{{user-site.url}}}', 'buddypress' ),
			/* translators: do not remove {} brackets or translate its contents. */
			'post_content' => __( "ようこそ!Piggiezへ。\n\nアカウントを有効化するために、以下のリンクをクリックしてください。: <a href=\"{{{activate-site.url}}}\">{{{activate-site.url}}}</a>.\n\nAfter you activate, you can visit your site at <a href=\"{{{user-site.url}}}\">{{{user-site.url}}}</a>.", 'buddypress' ),
			/* translators: do not remove {} brackets or translate its contents. */
			'post_excerpt' => __( "ようこそ!Piggiezへ。\n\nアカウントを有効化するために、以下のリンクをクリックしてください。: {{{activate-site.url}}}\n\nAfter you activate, you can visit your site at {{{user-site.url}}}.", 'buddypress' ),
		),
