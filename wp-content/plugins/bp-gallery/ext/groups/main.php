...
if (bp_is_gallery_enabled_for("groups")){
    ...
    add_action('bp_actions', 'setup_gallery_for_group',0);
    add_action('bp_actions', 'gallery_handle_group_gallery_actions',4);
...
function gallery_nav_for_group() {
    ...
    if ( bp_is_groups_component() && bp_is_single_item() ){
        ...
        $component_link =trailingslashit(bp_get_group_permalink(groups_get_current_group()) );//; bp_get_group_permalink($bp->groups->current_group);
...
function gallery_handle_group_gallery_actions() {
    ...
    if (bp_is_group_single() && $bp->current_action == $bp->gallery->slug) {
