...
function gallery_create_gallery( $args = '' ) {
    ...
    $default= array(
        ...
        'date_created'=>'',
        'order' => false,
        'owner_object_type' => false,
        'owner_object_id'   => false,
        'gallery_type' =>''
    ...
    if ( !empty( $slug ) && gallery_check_slug( $slug, $gallery->creator_id ) )//we will use owner id here
    	$gallery->slug = $slug;
...
//just to find current page url
function gallery_get_current_page_uri(){
