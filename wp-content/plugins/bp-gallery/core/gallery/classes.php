...
//v 1.1
	...
	public function __construct( $id = null, $single = false, $get_user_dataset = false ) {
		if ( $id ) {
			$this->id = $id;
	...
	public function populate( $get_user_dataset ) {
		global $wpdb, $bp;
		...
		if ( $this->id ) {
			$sql = $wpdb->prepare( "UPDATE {$bp->gallery->table_galleries_data} SET
					...
					date_created = FROM_UNIXTIME(%d)
                                        WHERE
					id = %d
                                        ", $this->parent_id, $this->creator_id, $this->title, $this->slug, $this->description, $this->cover_mini, $this->cover_mid, $this->cover_orig, $this->status, $this->gallery_type, $this->sort_order, $this->owner_object_type, $this->owner_object_id, $this->date_created, $this->id
			);
		} else {
			$sql = $wpdb->prepare(
				...
				)", $this->parent_id, $this->creator_id, $this->title, $this->slug, $this->description, $this->cover_mini, $this->cover_mid, $this->cover_orig, $this->status, $this->gallery_type, $this->sort_order, $this->owner_object_type, $this->owner_object_id, $this->date_created
			);
		}
...
//for user galleries deletion
	 ...
	 */
	public static function delete_gallery_for_user( $user_id ) {
		self::delete_gallery_for_owner( "user", $user_id );
	}

	public static function delete_gallery_for_owner( $owner_type, $owner_id ) {
		global $bp, $wpdb;
	...
	public static function delete_gallery_for_group( $group_id ) {
	 ...
	 */
	public static function get_order( $owner_type, $owner_id, $gallery_type ) {
		global $bp, $wpdb;
		$where_sql = null;
...
//helper function for preparing the order by sql
	public static function get_orderby_sql( $order_by, $sort_order ) {
		global $wpdb;
	 ...
	 */
	public static function get_all( $status_filter = array( 'public' ), $gallery_type = null, $owner_type = null, $owner_id = null, $limit = null, $page = null, $search_terms = null, $order_by = "sort_order", $sort_order = "ASC" ) {
		global $wpdb, $bp;
...
//find all group galleries of a user
	public static function get_all_user_group_galleries( $gallery_type, $user_id, $limit, $page, $search_terms, $order_by, $sort_order ) {
	...
	public static function get_all_by_type( $gallery_type = "all", $owner_type = null, $owner_id = null, $limit = null, $page = null, $status = "public", $order = "DESC" ) {
		global $wpdb, $bp;
	 ...
	 * 
	 */
	public static function get_gallery_list( $owner_type = null, $owner_id = null, $type = null ) {
//we may want to filter some time
	...
	public static function total_gallery_count( $owner_type = null, $owner_id = null, $access = array( "public" ) ) {
		global $bp, $wpdb;
		$cond = array();
		$where_sql = null;
		$where_conditions = array();
	...
	public static function get_gallery_count_by_type( $gallery_type, $owner_type, $owner_id, $status ) {
	...
	public static function update_time( $gallery_id ) {
		global $bp, $wpdb;
	...
	public static function gallery_exists( $slug, $owner_type, $owner_id ) {
		global $wpdb, $bp;
	...
	public static function gallery_exists_by_id( $id ) {
		global $wpdb, $bp;
	 ...
	 */
	public static function get_id_from_slug( $slug, $owner_type, $owner_id ) {
	 ...
	 *
	 */
	public static function check_slug( $slug, $owner_type = null, $owner_id = null ) {
		global $wpdb, $bp;
	 ...
	 */
	public static function get_slug( $gallery_id ) {
		global $wpdb, $bp;
	 ...
	 * @return <type> 
	 */
	public static function get_adjacent_gallery( $previous = true ) {
