...
function gallery_get_default_cover( $gallery, $type ) {
	...
	if ( empty( $cover_image ) && $gallery->gallery_type == "photo" && gallery_has_media( $gallery ) ) {//if this is an image gallery and has images//get the first image of the gallery and set it as the cover
...
function bp_directory_gallery_search_form() {
	...
	<form action="" method="get" id="search-gallery-form">
		<label><input type="text" name="s" id="gallery_search" value="<?php echo esc_attr( $search_value ) ?>"  onfocus="if ( this.value == '<?php _e( 'Search anything...', 'bp-gallery' ) ?>' ) {
						this.value = '';
					}" onblur="if ( this.value == '' ) {
								this.value = '<?php _e( 'Search anything...', 'bp-gallery' ) ?>';
							}" /></label>
...
function bp_gallery_directory_search_form() {
	...
	<form action="" method="get" id="search-gallery-form">
		<label><input type="text" name="s" id="gallery_search" value="<?php echo esc_attr( $search_value ) ?>"  onfocus="if ( this.value == '<?php echo $default_search_value ?>' ) {
						this.value = '';
					}" onblur="if ( this.value == '' ) {
								this.value = '<?php echo $default_search_value ?>';
							}" /></label>
		<input type="submit" id="gallery_search_submit" name="gallery_search_submit" value="<?php _e( 'Search', 'bp-gallery' ) ?>" />
	</form>
