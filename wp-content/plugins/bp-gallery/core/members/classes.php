...
Class BP_Gallery_Member {
	...
	public function __construct( $user_id = false, $gallery_id = false, $id = false, $populate = true ) {
	...
	public static function delete( $user_id, $gallery_id, $check_empty = true ) {
		global $wpdb, $bp;
	...
	public static function get_gallery_ids( $user_id, $limit = false, $page = false ) {
		global $wpdb, $bp;
	...
	public static function total_gallery_count( $user_id = false ) {
		global $bp, $wpdb;
	...
	public static function check_has_invite( $user_id, $gallery_id ) {
		global $wpdb, $bp;
	...
	public static function delete_invite( $user_id, $gallery_id ) {
		global $wpdb, $bp;
	...
	public static function check_is_admin( $user_id, $gallery_id ) {
		global $wpdb, $bp;
	...
	public static function check_is_mod( $user_id, $gallery_id ) {
		global $wpdb, $bp;
		if ( ! $user_id )
			return false;
	...
	public static function check_is_member( $user_id, $gallery_id ) {
		global $wpdb, $bp;
		if ( ! $user_id )
			return false;
	...
	public static function check_is_contributor( $user_id, $gallery_id ) {
		global $wpdb, $bp;
	...
	public static function check_is_banned( $user_id, $gallery_id ) {
		global $wpdb, $bp;
	...
	public static function check_for_membership_request( $user_id, $gallery_id ) {
		global $wpdb, $bp;
		if ( ! $user_id )
			return false;
	...
	public static function get_gallery_administrator_ids( $gallery_id ) {
		global $bp, $wpdb;
	...
	public static function get_gallery_moderator_ids( $gallery_id ) {
		global $bp, $wpdb;
	...
	public static function get_all_membership_request_user_ids( $gallery_id ) {
		global $bp, $wpdb;
	...
	public static function get_all_for_gallery( $gallery_id, $limit = false, $page = false, $exclude_admins_mods = true, $exclude_banned = true ) {
		global $bp, $wpdb;
		if ( $limit && $page )
			$pag_sql = $wpdb->prepare( "LIMIT %d, %d", intval( ( $page - 1 ) * $limit ), intval( $limit ) );
