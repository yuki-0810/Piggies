...
<?php //do_action( 'bp_before_gallery_content' ) ?>
	<div id="galleries">
		...
		<?php if(bp_has_galleries()):?>
			...
			<?php // include( bp_gallery_locate_template( array( 'gallery/single/activity.php' ), false ) )/*un comment this line if you want all the activities of a gallery listed here*/  ?>
			</div>
