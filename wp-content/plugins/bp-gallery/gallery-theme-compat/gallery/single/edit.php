...
if(bp_is_gallery_edit_details()){?>
		...
		<form action="" method="post" id="gallery_edit_info">
			<div class='edit-gallery clearfix' id="gallery_<?php echo bp_get_gallery_id($gallery);?>">
...
<?php }
    ...
    bp_gallery_locate_template(array("gallery/single/media/add-from-web.php"),true);
