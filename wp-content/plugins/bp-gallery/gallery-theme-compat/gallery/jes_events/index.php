<?php get_header() ?>
	...
	<?php if(bp_is_gallery_home())
			 bp_gallery_locate_template( array( 'gallery/jes_events/home.php' ), true ) ;
			 
		else if(bp_is_gallery_create())
			bp_gallery_locate_template( array( 'gallery/jes_events/create.php' ), true ) ;
			 	
		else if(bp_is_gallery_edit())
			bp_gallery_locate_template( array( 'gallery/jes_events/edit.php' ), true ) ;
			 
		else if(bp_is_gallery_upload())
			bp_gallery_locate_template( array( 'gallery/jes_events/upload.php' ), true ) ;
		 else if(bp_is_single_media())
			
			bp_gallery_locate_template( array( 'gallery/jes_events/single-media.php' ), true ) ;
		 
		else if(bp_is_single_gallery())
			
			bp_gallery_locate_template( array( 'gallery/jes_events/single.php' ), true ) ;
