...
<?php if ( bp_is_group_admin_screen( 'membership-requests' ) ) : ?>
			...
			<?php while ( bp_group_membership_requests() ) : bp_group_the_membership_request(); ?>
				...
				<li>
					...
					<div class="action">
						...
						<?php bp_button( array( 'id' => 'group_membership_accept', 'component' => 'groups', 'wrapper_class' => 'accept', 'link_href' => bp_get_group_request_accept_link(), 'link_title' => __( '承認', 'buddypress' ), 'link_text' => __( '承認', 'buddypress' ) ) ); ?>

						<?php bp_button( array( 'id' => 'group_membership_reject', 'component' => 'groups', 'wrapper_class' => 'reject', 'link_href' => bp_get_group_request_reject_link(), 'link_title' => __( '拒否', 'buddypress' ), 'link_text' => __( '拒否', 'buddypress' ) ) ); ?>
	...
	<?php else: ?>
		...
		<div id="message" class="info">
			<p><?php _e( 'メッセージはありません。', 'buddypress' ); ?></p>
		</div>
